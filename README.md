...
Per installare le librerie necessarie, apri il tuo terminale e digita i seguenti comandi.

```bash
# Questo è l'inizio del blocco di codice Bash
# "```bash" apre il blocco e abilita l'highlighting della sintassi Bash

pip install pandas numpy networkx matplotlib
python Project_Python.py

# Questo è l'ultimo comando del blocco.
